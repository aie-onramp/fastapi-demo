...
**Tasks**:
- [ ] T001 Create backend directory structure (backend/, backend/tests/)
- [ ] T002 Create frontend directory structure (frontend/src/, frontend/src/pages/, frontend/src/components/)
- [ ] T003 [P] Create backend/requirements.txt with dependencies (fastapi, anthropic, pydantic, uvicorn, datasets, pytest)
- [ ] T004 [P] Create frontend/package.json with dependencies (react, react-router-dom, vite)
- [ ] T005 [P] Create .env.example with ANTHROPIC_API_KEY placeholder
- [ ] T006 [P] Create .gitignore for Python, Node, and SQLite files
- [ ] T007 [P] Create backend/README.md with setup instructions
- [ ] T008 [P] Create frontend/README.md with dev server instructions
...
**Tasks**:
- [ ] T009 Implement SQLite schema creation in backend/database.py
- [ ] T010 Implement database connection function get_db() in backend/database.py
- [ ] T011 Implement data migration script backend/migrate_data.py (HuggingFace → SQLite)
- [ ] T012 Run migration to populate blackbird.db with 10 customers and 13 orders
- [ ] T013 [P] Define Pydantic models in backend/models.py (Customer, Order, ChatMessage, ChatResponse)
- [ ] T014 [P] Implement basic CRUD SQL functions in backend/database.py (get_customer, update_customer, get_order, etc.)
...
- [ ] T015 [US1] Define 6 Claude AI tool schemas in backend/ai_tools.py (get_user, get_order_by_id, get_customer_orders, cancel_order, update_user_contact, get_user_info)
- [ ] T016 [US1] Implement tool execution function execute_tool() in backend/ai_tools.py
- [ ] T017 [US1] Implement Claude API integration chat_with_claude() in backend/ai_tools.py
- [ ] T018 [US1] Create POST /api/chat endpoint in backend/main.py

### Frontend - Chat UI
- [ ] T019 [P] [US1] Create ChatMessage component in frontend/src/components/ChatMessage.jsx
- [ ] T020 [US1] Implement ChatPage with message history and input in frontend/src/pages/ChatPage.jsx
- [ ] T021 [US1] Implement sendChatMessage() in frontend/src/api.js

### Integration
- [ ] T022 [US1] Create FastAPI app initialization in backend/main.py with CORS
- [ ] T023 [US1] Create React App component with routing in frontend/src/App.jsx
- [ ] T024 [US1] Create frontend/index.html entry point
- [ ] T025 [US1] Create frontend/vite.config.js with proxy to backend
...
- [ ] T026 [P] [US2] Create GET /api/customers endpoint in backend/main.py
- [ ] T027 [P] [US2] Create POST /api/customers/search endpoint in backend/main.py
- [ ] T028 [P] [US2] Create PATCH /api/customers/{id} endpoint in backend/main.py
- [ ] T029 [P] [US2] Create GET /api/customers/{id}/orders endpoint in backend/main.py

### Frontend - Customer UI
- [ ] T030 [P] [US2] Create SearchBar component in frontend/src/components/SearchBar.jsx
- [ ] T031 [P] [US2] Create DataTable component in frontend/src/components/DataTable.jsx
- [ ] T032 [US2] Implement CustomersPage with search and table in frontend/src/pages/CustomersPage.jsx
- [ ] T033 [US2] Implement customer API functions in frontend/src/api.js (fetchCustomers, searchCustomers, updateCustomer)
...
### Backend - Order API
- [ ] T034 [P] [US3] Create GET /api/orders endpoint in backend/main.py with status filtering
- [ ] T035 [P] [US3] Create GET /api/orders/{id} endpoint in backend/main.py
- [ ] T036 [P] [US3] Create PATCH /api/orders/{id}/cancel endpoint in backend/main.py (with Processing status validation)

### Frontend - Order UI
- [ ] T037 [US3] Implement OrdersPage with status filter and cancel button in frontend/src/pages/OrdersPage.jsx (reuse DataTable component)
- [ ] T038 [US3] Implement order API functions in frontend/src/api.js (fetchOrders, cancelOrder)
